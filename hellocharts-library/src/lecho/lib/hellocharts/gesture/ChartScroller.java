...
public class ChartScroller {
    ...
    public boolean scroll(ChartComputator computator, float distanceX, float distanceY, ScrollResult scrollResult) {
        ...
        if (canScrollX || canScrollY) {
            ...
            showChartLog(distanceX+"<distanceX,viewportOffsetX:"+viewportOffsetX+",currentViewport.left:"+currentViewport.left+",distance:"+(computator.getLastRight()-contentRect.right));
...
//        if(computator.getLastRight()!=0)
//            width= (int) (computator.getLastRight()+20);
//        showChartLog("飞起来maxX:"+(surfaceSizeBuffer.x-width));
