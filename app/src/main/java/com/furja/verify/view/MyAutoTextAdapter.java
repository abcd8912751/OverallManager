...
public class MyAutoTextAdapter extends ArrayAdapter {

    private ArrayList<String> autoPrompts;
    private int layoutResourceID;
    public MyAutoTextAdapter(@NonNull Context context, int resource) {
        super(context, resource);
        autoPrompts=new ArrayList<String>();
        this.layoutResourceID=resource;
    }

    public MyAutoTextAdapter(@NonNull Context context, int resource, int textViewResourceId) {
        super(context, resource, textViewResourceId);
    }

    public MyAutoTextAdapter(@NonNull Context context, int resource, @NonNull Object[] objects) {
        super(context, resource, objects);
    }

    public MyAutoTextAdapter(@NonNull Context context, int resource, int textViewResourceId, @NonNull Object[] objects) {
        super(context, resource, textViewResourceId, objects);
    }

    public MyAutoTextAdapter(@NonNull Context context, int resource, @NonNull List objects) {
        super(context, resource, objects);
    }

    public MyAutoTextAdapter(@NonNull Context context, int resource, int textViewResourceId, @NonNull List objects) {
        super(context, resource, textViewResourceId, objects);
    }
